...
// Conteúdo de Termos/Privacidade extraído das páginas (Termos.tsx/
// Privacidade.tsx) pra ser reaproveitado também no modal aberto a partir do
// checkbox de aceite no cadastro (LegalModal.tsx) — mesmo texto, dois lugares.
