...
// eliminação, 8 times. Semente inicial pro banco (ver scripts/seedCompeticoes.ts)
// — depois de seedado uma vez, a edição de verdade acontece pela tela de
// Competições (admin), não editando este arquivo.
